...
public class EventCommonForge {
    ...
    {
        EventCommon.onPlayerJoined((Player) event.getEntity());
    }
    ...
    {
        EventCommon.onPlayerLeave((Player) event.getEntity());
    }
    ...
    public void OnPlayerHurt(LivingHurtEvent event)
    {
        ...
        event.setCanceled(EventCommon.OnPlayerHurt((Player) event.getEntity(), event.getSource().getDirectEntity()));
    }
