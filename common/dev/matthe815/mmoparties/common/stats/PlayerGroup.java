...
public abstract class PlayerGroup {
	 ...
	 * @param message
	 */
	public abstract void Broadcast (ITextComponent message);
	...
	{
		this.leader = member;
		this.Broadcast(new TranslationTextComponent("rpgparties.message.leader.make", member.getName(), this.GetGroupAlias()));
