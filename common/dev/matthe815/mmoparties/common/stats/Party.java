...
{	
	...
	public void Join ( Player player, boolean displayMessage )
	{
		...
		if (displayMessage) Broadcast( new TranslatableComponent( "rpgparties.message.party.joined", player.getName().getString() ) );
	...
	public void Leave (Player player)
	{
		...
		Broadcast( new TranslatableComponent( "rpgparties.message.party.player.left", player.getName().toString() ) );
