...
public class PartyList {
    ...
    public static void onRenderGameOverlay(PoseStack stack) {
        updateCounter++;
     ...
     * @return X and Y
     */
    public static UISpec GetAnchorOffset(PoseStack graphics)
    {
    ...
    public interface NuggetBar {
        int Render(PoseStack gui, BuilderData data, int xOffset, int yOffset, boolean compact);
    }
    ...
    {
        Renderer.drawString(location, text);
        return 8;
    }
