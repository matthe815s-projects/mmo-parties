...
public class InvitedScreenCommon extends GuiScreen {
    ...
    public static void ShowToast() {
        Minecraft.getMinecraft().getToastGui().add(new InvitedScreenCommon.InvitedToast());
    }


    public GuiButton CreateButton(String text, int buttonNumber, IPressable pressable) {
